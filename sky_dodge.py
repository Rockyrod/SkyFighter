...
# Defin the enemy object by extending pygame.sprite.Sprite
# The surface you draw on the screen is an attribute of 'enemy'
class Enemy(pygame.sprite.Sprite):
    ...
    # Remove the sprite when it passes the lef edge of the screen
...
while running:
    ...
    for event in pygame.event.get():
        ...
        # Add a new enemy?
            ...
            # create the new enemy and add it to the sprite group
            new_enemy = Enemy()
